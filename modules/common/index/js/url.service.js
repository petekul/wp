...
angular.module("SSO.url").service("urlService", ["$http", "$q", function($http, $q) {
  ...
  return {
    loadURLs: function(){
        ...
        var getenv = $http.get("/sso/src/main/webapp/scripts/app/common/index/config/environment.json");
        var geturls = $http.get("/sso/src/main/webapp/scripts/app/common/index/config/urls.json");
